...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.guests'
        db.add_column(u'letsparty_event', 'guests',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.guests'
        db.delete_column(u'letsparty_event', 'guests')
    ...
    models = {
        ...
        u'letsparty.event': {
            ...
            'guests': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
